...
void Md5::MD5Final(MD5_CTX *context,unsigned char *digest)
{
...
void Md5::Md5Sum(unsigned char *encrypt,unsigned char *decrypt)
{
    MD5_CTX md5;
    MD5Init(&md5);
    int i;
    unsigned char decryptorg[16];
    MD5Update(&md5,encrypt,strlen((char *)encrypt));
    MD5Final(&md5,decryptorg);
//    printf("before:%s\t:after:",encrypt);
    for(i=0;i<16;i++)
    {
//        printf("%02x",decryptorg[i]);
    }
    memcpy(decrypt,decryptorg,sizeof(decryptorg));
    printf("\n");
}
